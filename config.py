...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002127070393"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "7143727843"))

#Port
PORT = os.environ.get("PORT", "3090")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002079942750"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002129848038"))
