...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7124993596:AAGYnG6wL1Dbw6sMLOYRGzgfiRzJvd5KI_Q")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002004548388"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "6318448139").split()):
        ADMINS.append(int(x))
except ValueError:
